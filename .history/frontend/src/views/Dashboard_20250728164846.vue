    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid lg:grid-cols-2 gap-8">
        ...
        <div v-if="user.role === 'ADMIN'" class="card">
          <h3 class="text-lg font-semibold mb-4">Painel Administrativo</h3>
          <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div class="text-center p-4 bg-yellow-50 rounded-lg">
                <div class="text-2xl font-bold text-yellow-600">{{ adminStats.pending }}</div>
                <div class="text-sm text-gray-600">Pendentes</div>
              </div>
              <div class="text-center p-4 bg-green-50 rounded-lg">
                <div class="text-2xl font-bold text-green-600">{{ adminStats.approved }}</div>
