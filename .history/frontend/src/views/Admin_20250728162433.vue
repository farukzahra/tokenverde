              ...
              <div class="flex-1">
                ...
                <div class="flex space-x-2 mt-2">
                  <a 
                    ...
                    :href="`http://localhost:5001/api/properties/${property.id}/matricula`"
                    target="_blank"
                  ...
                  <a 
                    v-if="property.car"
                    :href="`http://localhost:5001/api/properties/${property.id}/car`"
                    target="_blank"
                  ...
                  <a 
                    ...
                    :href="`http://localhost:5001/api/properties/${property.id}/georreferenciamento`"
                    target="_blank"
