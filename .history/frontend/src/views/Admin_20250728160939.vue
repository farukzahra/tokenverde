          ...
          >
            <div class="flex justify-between items-start">
              ...
              <div class="flex items-center space-x-2">
                ...
                <div v-else-if="property.status === 'APPROVED'" class="flex space-x-2">
                  <button 
                ...
                <div v-else-if="property.status === 'INACTIVE'" class="flex space-x-2">
                  <button 
                    @click="updatePropertyStatus(property.id, 'ACTIVE')"
                    class="px-3 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full hover:bg-blue-200"
                  >
                ...
                <div v-else-if="property.status === 'REJECTED'" class="flex space-x-2">
                  <button 
                    @click="updatePropertyStatus(property.id, 'PENDING')"
